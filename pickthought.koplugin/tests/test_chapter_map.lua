...
T.case("章节边界只检查相关候选并返回指标", function()
    ...
    local chapters = {
        {uid = "1", title = "第一章 甲乙丙丁", underlines = {{range = "0-8", markText = "第一章的正文引文甲乙丙丁"}}},
        {uid = "2", title = "第二章 戊己庚辛", underlines = {{range = "0-8", markText = "第二章的正文引文戊己庚辛"}}},
        {uid = "3", title = "第三章 壬癸子丑", underlines = {{range = "0-8", markText = "第三章的正文引文壬癸子丑"}}},
    }
...
T.case("章节映射检查点取消会停止扫描", function()
    ...
    local ok, err = pcall(function()
        return ChapterMap.build({{href = "c1.xhtml"}, {href = "c2.xhtml"}}, function()
